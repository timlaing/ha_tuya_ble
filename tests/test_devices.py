...
class TestProductInfoByIds:
    """Tests for get_product_info_by_ids registry lookups."""
    ...
    def test_product_unknown_falls_back_to_category_info(self) -> None:
    ...
    def test_fingerbot_product(self) -> None:
    ...
    def test_device_product_info(self) -> None:
...
class TestShortAddress:
    """Tests for get_short_address formatting."""
...
class TestReadableName:
    """Tests for get_device_readable_name discovery naming."""

    async def test_with_product_and_credentials(self) -> None:
    ...
    async def test_with_credentials_no_product(self) -> None:
    ...
    async def test_credentials_none(self) -> None:
...
class TestDeviceInfo:
    """Tests for get_device_info device registry data."""
    ...
    def test_get_device_info_no_product(self) -> None:
...
class TestCoordinator:
    """Tests for the TuyaBLECoordinator connection lifecycle."""
    ...
    def test_initial_state_disconnected(self, hass: HomeAssistant) -> None:
        """Verify the coordinator starts disconnected."""
        coord, _ = self._make_coord(hass)
        assert coord.connected is False

    def test_connect_twice_runs_cleaner(self, hass: HomeAssistant) -> None:
    ...
    def test_connect_when_disconnected(self, hass: HomeAssistant) -> None:
    ...
    def test_set_disconnected(self, hass: HomeAssistant) -> None:
    ...
    def test_handle_disconnect_schedules_timer(self, hass: HomeAssistant) -> None:
    ...
    def test_handle_disconnect_already_scheduled(self, hass: HomeAssistant) -> None:
    ...
    async def test_handle_update_fires_fingerbot_event(
        ...
        coordinator, device = self._make_coord(hass)
    ...
    async def test_handle_update_no_fingerbot_event(self, hass: HomeAssistant) -> None:
        """Do not fire an event for devices without fingerbot specs."""
        coordinator, _ = self._make_coord(hass)
        captured: list[Event[Any]] = []
        hass.bus.async_listen(FINGERBOT_BUTTON_EVENT, captured.append)
        with patch(
            "custom_components.tuya_ble.devices.get_device_product_info",
...
class TestEntityInitTranslationKey:
    """Tests for TuyaBLEEntity.__init__ with translation_key."""

    def _make_desc(self, translation_key: str | None = None) -> EntityDescription:
    ...
    def test_translation_key_set_on_entity(self) -> None:
    ...
    def test_translation_key_not_overridden(self) -> None:
        ...
        desc = self._make_desc(translation_key="my_key")
        entity = TuyaBLEEntity(MagicMock(), coordinator, dev, MagicMock(), desc)
...
class TestCoordinatorConnectPath:
    """Tests for _async_handle_connect paths."""

    def test_already_connected_no_update(self, hass: HomeAssistant) -> None:
...
class TestEntityHandleCoordinatorUpdate:
    """Tests for TuyaBLEEntity._handle_coordinator_update."""

    def test_calls_async_write_ha_state(self, hass: HomeAssistant) -> None:
...
class TestFingerbotEventChangedByDevice:
    """Tests for fingerbot event with changed_by_device=False."""

    async def test_no_event_when_not_changed_by_device(
        self, hass: HomeAssistant
    ) -> None:
...
class TestEntityFindDpid:
    """Tests for TuyaBLEEntity.find_dpid."""

    def _make_entity_with_device(self) -> tuple[TuyaBLEEntity, TuyaBLEDevice]:
...
class TestEntityFindDpcode:
    ...
    def test_find_dpcode_with_enum_dptype(self) -> None:
...
class TestEntityGetDptype:
    """Tests for TuyaBLEEntity.get_dptype."""
