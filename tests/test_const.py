...
class TestTuyaBLECode:
    """Tests for the TuyaBLECode enum member values."""
    ...
    def test_code_values(self, member: TuyaBLECode, value: int) -> None:
        """Assert each TuyaBLECode member holds the expected integer value."""
        assert member.value == value


class TestTuyaBLEDataPointType:
    """Tests for the TuyaBLEDataPointType enum member values."""
    ...
    def test_type_values(self, member: TuyaBLEDataPointType, value: int) -> None:
